...
namespace CSharp_Rental_System_Car
{
    internal class db
    {
        protected private static string DBName = "arackiralama";
        

        public static string _Access = @"Data Source = LAPTOP-MBBQNF15\SQLEXPRESS;MultipleActiveResultSets=True; Initial Catalog='" + DBName + "';Integrated Security=True";
